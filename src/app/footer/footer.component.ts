  ...
  sections: FooterSection[] = [
    {
      ...
      title: 'Unternehmen',
      menuItems: [
        ...this.appService.mainMenuItems,
        { type: 'intern', id: 'career', href: '/career', text: 'Karriere' },
      ],
    },
    {
      id: 'social-links',
      ...
      menuItems: [
        {
          type: 'extern',
          id: 'facebook',
          href: 'https://facebook.ch/Ilazi Innenausbau GmbH',
          text: 'Facebook',
        ...
        },
        {
          type: 'extern',
          id: 'instagram',
          href: 'https://instagram.ch/Ilazi Innenausbau GmbH',
          text: 'Instagram',
          icon: `<svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        <path fill-rule="evenodd"
        ...
        },
        {
          type: 'extern',
          id: 'twitter',
          href: 'https://twitter.ch/Ilazi Innenausbau GmbH',
          text: 'Twitter',
          icon: `<svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        <path
